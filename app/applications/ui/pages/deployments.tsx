      ...
      <Card className="mt-4">
        <CardHeader className="">
          <div className="flex items-start space-x-4">
            <div>
              <CardTitle>Choose a GitHub Repository</CardTitle>
              <CardDescription>Which application should we deploy today?</CardDescription>
            </div>
            <a
              className="btn-secondary"
              href="https://github.com/apps/valyenttest/installations/new"
            >
              <svg role="img" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">

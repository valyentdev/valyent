  ...
  return (
    <div className="flex items-center space-x-2">
      ...
      {(machine.state === MachineStatus.Stopped || machine.state === MachineStatus.Stopping) && (
        <button
          className="hover:opacity-85 transition-opacity p-1 flex items-center justify-center bg-gradient-to-b from-white/75 to-blue-100/75 rounded-sm shadow-sm shadow-blue-800/10 ring-1 ring-blue-800/10"
          onClick={handleStart}
        >
      ...
      {machine.state !== MachineStatus.Stopped && machine.state !== MachineStatus.Stopping && (
        <button
          className="hover:opacity-85 transition-opacity p-1 flex items-center justify-center bg-gradient-to-b from-white/75 to-red-100/75 rounded-sm shadow-sm shadow-red-800/10 ring-1 ring-red-800/10"
          onClick={handleStop}
        >
